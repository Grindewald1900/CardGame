...
namespace Tools.UI.Card
{
    public class UiPlayerHandUtils : MonoBehaviour
    {
        ...
        public void DrawCard()
        {
            ...
            if(Count == 0){
                //Output cardGo information
                Debug.Log(cardGo.name);
                //output cardgo components and scripts
                Debug.Log(cardGo.GetComponents<MonoBehaviour>());
                Debug.Log(cardGo.GetComponents<IUiCard>());
                //print card type
